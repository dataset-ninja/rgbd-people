...
GITHUB_URL: str = "https://github.com/dataset-ninja/rgbd-people"
...
AUTHORS: Optional[List[str]] = ["Luciano Spinello", "Kai O. Arras", "Matthias Luber"]
AUTHORS_CONTACTS: Optional[List[str]] = ["spinello@informatik.uni-freiburg.de"]

ORGANIZATION_NAME: Optional[Union[str, List[str]]] = "University of Freiburg, Germany"
ORGANIZATION_URL: Optional[Union[str, List[str]]] = (
    "https://www.researchgate.net/institution/University_of_Freiburg"
)
...
TAGS: Optional[List[str]] = ['multi-view', 'multi-camera']
